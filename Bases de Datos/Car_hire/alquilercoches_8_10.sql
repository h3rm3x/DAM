...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 08, 2024 at 07:41 PM
...
--
ALTER TABLE `reservas`
  ADD CONSTRAINT `car_ID` FOREIGN KEY (`car_id`) REFERENCES `coche` (`car_id`),
  ADD CONSTRAINT `client_ID` FOREIGN KEY (`id_client`) REFERENCES `cliente` (`id_client`);
COMMIT;
