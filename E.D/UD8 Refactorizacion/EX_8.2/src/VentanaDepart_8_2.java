...
public class VentanaDepart_8_2 extends JFrame implements ActionListener  {
	
private static final long serialVersionUID = 1L;
private final String departamentoNoExist = "DEPARTAMENTO NO EXISTE.";
private final String departamentoExist = "DEPARTAMENTO EXISTE.";
private final String deparError = "DEPARTAMENTO ERRÓNEO";
...
public VentanaDepart_8_2(JFrame f )
{ 	
...
{   int dep, confirm;
	if (e.getSource() == balta) { //SE PULSA EL BOTON alta
		...
		try {
	    	  ...
	    	  if (dep >0)
	    	      if (consultar(dep))
					 mensaje.setText(departamentoExist);
			      else
	    	  ...
	    	  if (dep >0)
	    	      if (consultar(dep))
	    	       { mensaje.setText(departamentoExist);
					...
					{ mensaje.setText(departamentoNoExist);
